...
**Quick Start:** See [.github/docs/QUICKSTART.md](.github/docs/QUICKSTART.md) for 5-minute setup.

**Complete Guide:** See [.github/docs/OIDC_SETUP.md](.github/docs/OIDC_SETUP.md) for detailed configuration instructions.
